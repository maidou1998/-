...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxb5cddec90d952426',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'f116d27bbff3014c57113c2bb68c2712',
  ...
  USERS: [
    {
      ...
      id: 'o3uWK5s7qro5pa2mwq_Az8ElYVV4',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'fDVamcPJ7_N6GEV2yN_nEkBElugkBK_SRC1n-gPXKwc',
      // 所在省份
      province: '四川',
      // 所在城市
      city: '成都',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-12-16' },
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: 'fDVamcPJ7_N6GEV2yN_nEkBElugkBK_SRC1n-gPXKwc',
